...
<div id="mainSection">
<p>This sample shows how to enumerate all app packages installed on the system, and enumerate every user that installed each package.
</p>
...
<p>The sample uses <a href="http://msdn.microsoft.com/en-us/library/windows/desktop/br240969">
<b>PackageManager.FindPackages()</b></a> to find all installed packages for all users.</p>
...
<dl><dt><b>Samples</b> </dt><dt><a href="http://code.msdn.microsoft.com/windowsdesktop/Package-Manager-Inventory-fe747b8a">Enumerate app packages by name and publisher sample</a>
...
<p>Go to the directory where you downloaded the FindPackages sample.</p>
</li><li>
<p>Run the following command:</p>
<p><b>msbuild FindPackagesSample.sln</b>.</p>
</li></ol>
...
<p>Go to the directory where you downloaded the FindPackages sample and double-click its Microsoft Visual Studio Solution (.sln) file.</p>
</li><li>
...
<p>Go to the directory that contains FindPackagesSample.exe.</p>
</li><li>
<p>Run the following command:</p>
<p><b>FindPackagesSample</b>.</p>
</li></ol>
</div>
