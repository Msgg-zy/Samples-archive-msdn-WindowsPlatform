...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/OneDriveFilesPage/OneDriveFilesPage.html", {
        ready: function (element, options) {
            ...
            document.getElementById("DisplayAvailability").addEventListener("click", OnDisplayAvailabilityClick, false);
        },
