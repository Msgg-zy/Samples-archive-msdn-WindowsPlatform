...
<h1><a id="gallery_samples.httpcalculatorwithbasicoversslservice_gallery"></a>Windows Web Services HTTP service host with SSL and basic authentication sample</h1>
</div>
<p>This sample shows how to use a service host with the <a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435">
Windows Web Services API</a> to host a calculator service over HTTP with SSL transport security and HTTP header basic authentication. In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.
 Client authentication is provided to the host by a username/password pair supplied in HTTP headers using basic authentication.</p>
