...
Windows Web Services API</a> to implement a complex asynchronous function using <b>
WsAsyncExecute</b>. This is done by creating an asynchronous function that adds three integers by building upon an existing
<b>Add</b> function, which can add two integers asynchronously. </p>
...
<dl><dt><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430484"><b>WsAsyncExecute</b></a>
...
<ol>
<li>Open <b>Windows Explorer</b> and navigate to the directory. </li><li>Double-click the icon for the <b>AsyncAdd3Implicit.sln</b> (solution) file to open the file in Visual Studio.
...
<ol>
<li>Open the <b>Command Prompt</b> window and navigate to the directory. </li><li>Type <b>msbuild AsyncAdd3Implicit.sln</b> </li></ol>
