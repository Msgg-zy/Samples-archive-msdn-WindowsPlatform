...
writing Direct3D 11 code for Windows Store apps, Windows 8 Desktop, Windows 7 
'classic' applications, and Windows Phone 8 applications, in C++.
...
Commandline options for the MakeSpriteFont tool:
    ...
    /TextureFormat:<value>
        What format should the output texture be? Options:
            ...
            Bgra4444
                Good choice for color fonts on Windows Store and Windows Phone 
                platforms, but this format requires the DirectX 11.1 Runtime and a 
                WDDM 1.2 driver.
            CompressedMono
...
September 7, 2012
    ...
    Renamed existing project files for better naming consistency
