...
Windows Web Services API</a> to forward a message. </p>
...
<ol>
<li>Open <b>Windows Explorer</b> and navigate to the directory. </li><li>Double-click the icon for the <b>ForwardMessage.sln</b> (solution) file to open the file in Visual Studio.
...
<ol>
<li>Open the <b>Command Prompt</b> window and navigate to the directory. </li><li>Type <b>msbuild ForwardMessage.sln</b>. </li></ol>
