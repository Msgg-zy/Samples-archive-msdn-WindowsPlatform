# Windows Web Services HTTP calculator with SSL service sample
## Requires
* Visual Studio 2012
## License
* MS-LPL
...
Windows Web Services API</a> can use the service host for hosting a calculator service over HTTP, with SSL transport security.
</p>
