...
<div id="mainSection">
<p>This sample shows how to inject touch pointer input into the Windows message queue. Specifically, this sample covers using the
<a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd562197">Touch Input</a> APIs to inject touch-down messages and touch-up messages.
</p>
...
<dl><dt><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd562197">Touch Input</a>
</dt></dl>
