...
Windows Web Services API</a> to implement a HTTP client that sends request-reply messages. This sample demonstrates how the
<a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435">Windows Web Services API</a> can be used to implement an HTTP client that sends request-reply messages to untyped service with the
<a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430451">Service Model</a>.</p>
