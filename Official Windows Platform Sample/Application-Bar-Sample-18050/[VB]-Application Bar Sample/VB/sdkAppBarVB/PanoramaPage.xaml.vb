...
Partial Public Class PanoramaPage
    ...
    Public Sub New()
        ...
        If CDbl(Application.Current.Resources("PhoneDarkThemeOpacity")) = 1 Then
            'dark theme
            imageBrush.ImageSource = New BitmapImage(New Uri("Images/pano_dark.jpg", UriKind.Relative))
        Else
            'light theme
            imageBrush.ImageSource = New BitmapImage(New Uri("Images/pano_light.jpg", UriKind.Relative))
        End If
