...
#End If
        ...
        If rootFrame Is Nothing Then
            ...
            rootFrame = New Frame()
            HelloWorld_Part4.Common.SuspensionManager.RegisterFrame(rootFrame, "appFrame")

            If e.PreviousExecutionState = ApplicationExecutionState.Terminated Then
                ' TODO: Load state from previously suspended application
                Await HelloWorld_Part4.Common.SuspensionManager.RestoreAsync()
            End If
    ...
    Private Async Sub OnSuspending(sender As Object, e As SuspendingEventArgs) Handles Me.Suspending
        ...
        Await HelloWorld_Part4.Common.SuspensionManager.SaveAsync()
        deferral.Complete()
    End Sub
