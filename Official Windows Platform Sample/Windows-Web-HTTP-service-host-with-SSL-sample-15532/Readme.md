...
Windows Web Services API</a> to host a calculator service over HTTP with SSL transport security.
</p>
<p>It also shows how to use the <i>Wsutil.exe</i> generated policy helper routines to create a service proxy. In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</p>
