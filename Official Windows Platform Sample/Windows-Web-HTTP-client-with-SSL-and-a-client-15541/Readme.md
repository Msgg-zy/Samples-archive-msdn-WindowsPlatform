...
<h1><a id="gallery_samples.httpclientwithsslandclientcert_gallery"></a>Windows Web Services HTTP client with SSL and a client certificate sample</h1>
</div>
<p>This sample demonstrates how to use the <a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435">
Windows Web Services API</a> to implement an HTTP client that sends request-reply messages with SSL transport security using a client certificate.
</p>
