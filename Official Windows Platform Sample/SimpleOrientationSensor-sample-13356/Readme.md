...
<div id="mainSection">
<p>This sample shows how to use the <a href="http://msdn.microsoft.com/library/windows/apps/br206400">
<b>Windows.Devices.Sensors.SimpleOrientationSensor</b></a> API. </p>
