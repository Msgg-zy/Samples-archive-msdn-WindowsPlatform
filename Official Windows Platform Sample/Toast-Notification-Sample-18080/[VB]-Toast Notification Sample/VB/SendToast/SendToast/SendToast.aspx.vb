...
Partial Public Class SendToast
    ...
    ''' <param name="e"></param>
    Protected Sub ButtonSendToast_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim toastMessage As String = "<?xml version=""1.0"" encoding=""utf-8""?>" & "<wp:Notification xmlns:wp=""WPNotification"">" & "<wp:Toast>" & "<wp:Text1>" & TextBoxTitle.Text.ToString() & "</wp:Text1>" & "<wp:Text2>" & TextBoxSubTitle.Text.ToString() & "</wp:Text2>" & "<wp:Param>/Page2.xaml?NavigatedFrom=Toast Notification</wp:Param>" & "</wp:Toast> " & "</wp:Notification>"
