...
Windows Web Services API</a> to talk to a calculator service with SSL transport security. In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</p>
