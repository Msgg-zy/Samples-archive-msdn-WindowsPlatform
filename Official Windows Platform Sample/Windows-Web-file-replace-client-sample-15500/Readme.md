...
<div id="mainSection">
<p>This command line tool drives the Windows Web Services file replace service sample.
</p>
...
<ol>
<li>Open <b>Windows Explorer</b> and navigate to the directory. </li><li>Double-click the icon for the <b>FileRepTool.sln</b> (solution) file to open the file in Visual Studio.
...
<ol>
<li>Open the <b>Command Prompt</b> window and navigate to the directory. </li><li>Type <b>msbuild FileRepTool.sln</b>. </li></ol>
