...
<h1><a id="gallery_samples.httpcustomheaderpurchaseorderclient_gallery"></a>Windows Web Services HTTP custom header purchase order client sample</h1>
</div>
<p>This sample demonstrates how the <a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435">
Windows Web Services API</a> can use custom headers with a service proxy. </p>
