# DirectWrite color font fallback sample
## Requires
* Visual Studio 2013
## License
* MS-LPL
...
* DirectX
## Topics
* text glyph custom font fallback
## IsPublished
* True
## ModifiedDate
* 2013-11-25 04:25:21
...
<div id="mainSection">
<p>This sample shows how to enable color fonts and use custom font fallback. This technique controls how glyphs not available in the base font will be looked up in the font fallback list.
</p>
