    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        public NavigationHelper(Page page)
        {
            ...
            this.Page.Loaded += (sender, e) =>
            {
                ...
                // Set keyboard focus to fist color selector button.
                if (this.Page.Name == "page2")
                {
                    Button x = this.Page.FindName("Red") as Button;
        ...
        public void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this._pageKey = string.Format("Page-{0}", this.Frame.BackStackDepth);
