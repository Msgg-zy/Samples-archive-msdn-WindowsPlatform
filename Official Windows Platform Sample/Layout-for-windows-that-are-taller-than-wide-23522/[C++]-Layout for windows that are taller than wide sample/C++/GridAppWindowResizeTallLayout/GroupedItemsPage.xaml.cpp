...
GroupedItemsPage::GroupedItemsPage()
{
	...
	SizeChanged += ref new Windows::UI::Xaml::SizeChangedEventHandler(this, &GridAppWindowResizeTallLayout::GroupedItemsPage::OnSizeChanged);
}
...
void GridAppWindowResizeTallLayout::GroupedItemsPage::OnSizeChanged(Platform::Object ^sender, Windows::UI::Xaml::SizeChangedEventArgs ^e)
{
	(void) sender;	// Unused parameter
