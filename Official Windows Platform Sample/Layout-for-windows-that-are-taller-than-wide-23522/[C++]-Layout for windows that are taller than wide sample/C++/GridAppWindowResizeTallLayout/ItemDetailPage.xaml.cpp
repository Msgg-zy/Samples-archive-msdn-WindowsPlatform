...
ItemDetailPage::ItemDetailPage()
{
	...
	SizeChanged += ref new Windows::UI::Xaml::SizeChangedEventHandler(this, &GridAppWindowResizeTallLayout::ItemDetailPage::OnSizeChanged);
}
...
void GridAppWindowResizeTallLayout::ItemDetailPage::OnSizeChanged(Platform::Object ^sender, Windows::UI::Xaml::SizeChangedEventArgs ^e)
{
