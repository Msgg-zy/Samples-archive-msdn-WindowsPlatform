...
Windows Web Services API</a> to add and retrieve a custom header. </p>
...
<dl><dt><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430479"><b>WsAddCustomHeader</b></a>
</dt></dl>
...
<ol>
<li>Open <b>Windows Explorer</b> and navigate to the directory. </li><li>Double-click the icon for the <b>CustomHeader.sln</b> (solution) file to open the file in Visual Studio.
...
<ol>
<li>Open the <b>Command Prompt</b> window and navigate to the directory. </li><li>Type <b>msbuild CustomHeader.sln</b>. </li></ol>
