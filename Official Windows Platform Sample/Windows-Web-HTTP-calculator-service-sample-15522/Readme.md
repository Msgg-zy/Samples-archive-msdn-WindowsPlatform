...
Windows Web Services API</a> can use the service host to host a calculator service over HTTP.
</p>
...
</dt><dt><a href="http://go.microsoft.com/fwlink/p/?linkid=258657">Windows Web Services HTTP calculator client sample</a>
</dt></dl>
