...
Windows Web Services API</a> to implement a client app that shows how to abandon a call.
</p>
...
<dl><dt><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430472"><b>WsAbandonCall</b></a>
...
<ol>
<li>Open <b>Windows Explorer</b> and navigate to the directory. </li><li>Double-click the icon for the <b>CallAbandon.sln</b> (solution) file to open the file in Visual Studio.
...
<ol>
<li>Open the <b>Command Prompt</b> window and navigate to the directory. </li><li>Type <b>msbuild CallAbandon.sln</b>. </li></ol>
