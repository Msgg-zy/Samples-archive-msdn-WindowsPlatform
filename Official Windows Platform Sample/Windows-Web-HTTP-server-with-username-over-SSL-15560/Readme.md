...
Windows Web Services API</a> to create a TCP server that accepts a channel, and receives and replies to messages, with username over SSL mixed-mode security. In this scenario, the transport connection is protected (signed, encrypted) by SSL which also provides
