...
<div id="mainSection">
<p>This sample demonstrates Direct3D resource loading for C&#43;&#43; apps with DirectX. </p>
<p>Specifically, this sample covers:</p>
<ul>
<li>Build-time processing of author-time format shaders, textures, and meshes </li><li>Asynchronous run-time loading of the corresponding run-time formats </li></ul>
<p></p>
