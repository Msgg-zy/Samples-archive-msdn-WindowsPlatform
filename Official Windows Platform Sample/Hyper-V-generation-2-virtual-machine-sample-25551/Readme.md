...
<div id="mainSection">
<p>This sample demonstrates how to use the Hyper-V WMI APIs to manage generation 2 virtual machines.
</p>
...
<p>Go to the directory in which you unzipped the sample. Go to the directory named for the sample, and double-click the Microsoft Visual Studio Solution (.sln) file titled gen2vm.sln from Visual Studio&nbsp;2013.</p>
</li><li>
