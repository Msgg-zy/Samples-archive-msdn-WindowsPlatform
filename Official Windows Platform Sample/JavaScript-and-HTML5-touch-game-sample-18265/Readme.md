...
<p></p>
<p>This sample also demonstrates AppBar integration, accessed by swiping up with a touch gesture from the bottom edge of the screen. The main navigation elements of the sample are available there. Additionally, when on the game screen, there are game-specific
...
<p>This sample is written in JavaScript and HTML5.</p>
