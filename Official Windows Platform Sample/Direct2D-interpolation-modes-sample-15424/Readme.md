# Direct2D interpolation modes sample
## Requires
* Visual Studio 2013
## License
* MS-LPL
...
<div id="mainSection">
<p>This sample shows the various interpolation modes used by <a href="http://msdn.microsoft.com/library/windows/apps/dd370990">
Direct2D</a>.</p>
<p>These topics provide more info about the feature areas used in this sample:</p>
<ul>
<li><a href="http://msdn.microsoft.com/library/windows/apps/dd370990">Direct2D</a>, which you use to render the images, primitives, and an so on.
...
<ul>
<li>The <a href="http://msdn.microsoft.com/library/windows/apps/hh447004"><b>D2D1_INTERPOLATION_MODE</b></a> enumeration, which you use to specify the interpolation mode.
</li><li>The <a href="http://msdn.microsoft.com/library/windows/apps/hh706309">2D affine transform effect</a>, which you use to transform and scale an image. The effect applies the interpolation more for you during the transform process.
