...
namespace sdkBasicStorageRecipesWP8CS
{
    public partial class App : Application
    {
        ...
        const string FOLDER_LIST_NAME = "FoldersToDelete.txt";
        const string FILE_LIST_NAME = "FilesToDelete.txt";
        ...
        {
            foldersToDelete = await StateHelper.LoadList(FOLDER_LIST_NAME);
            filesToDelete = await StateHelper.LoadList(FILE_LIST_NAME);
        }
