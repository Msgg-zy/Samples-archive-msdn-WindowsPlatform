(function () {
    ...
    WinJS.UI.Pages.define("/html/groupedItemsPage.html", {
        // Navigates to the groupHeaderPage. Called from the groupHeaders.
        navigateToGroup: function (key) {
            nav.navigate("/html/groupDetailPage.html", { groupKey: key });
        },
        ...
        _itemInvoked: function (e) {
            ...
            //nav.navigate("/html/itemDetail.html", { item: Data.getItemReference(item) });
        },
    });
