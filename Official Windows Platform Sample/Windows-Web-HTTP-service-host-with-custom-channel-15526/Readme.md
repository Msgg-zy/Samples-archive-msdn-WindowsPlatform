...
<h1><a id="gallery_samples.httpcalculatorwithencodedchannelservice_gallery"></a>Windows Web Services HTTP service host with custom channel and encoder sample</h1>
</div>
...
Windows Web Services API</a> to host an HTTP-based calculator service with a custom channel and listener implementation. The channel uses a custom encoder.
</p>
