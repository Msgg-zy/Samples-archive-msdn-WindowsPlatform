...
<div id="mainSection">
<p>The sample demonstrates the use of the Location API to handle location awareness events.
</p>
...
<p>Go to the directory in which you unzipped the sample. Go to the directory named for the sample, and double-click the Microsoft Visual Studio Solution (.sln) file titled LocationEvents.sln.</p>
</li><li>
