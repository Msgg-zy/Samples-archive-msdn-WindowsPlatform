...
GroupDetailPage::GroupDetailPage()
{
	...
	SizeChanged += ref new Windows::UI::Xaml::SizeChangedEventHandler(this, &GridAppWindowResize::GroupDetailPage::OnSizeChanged);
...
void GridAppWindowResize::GroupDetailPage::OnSizeChanged(Platform::Object ^sender, Windows::UI::Xaml::SizeChangedEventArgs ^e)
{
	(void) sender;	// Unused parameter
