...
<div id="mainSection">
<p>This sample demonstrates the use of Direct3D HLSL and DirectCompute compute shaders to create fractal images.
</p>
<p>Specifically, this sample demonstrates:</p>
<ul>
<li>High Level Shader Language (HLSL) implementation </li><li>The use of DirectCompute compute shaders for computationally intensive tasks </li></ul>
<p></p>
<p>For more info about the concepts and APIs demonstrated in this sample, see these topics:</p>
<ul>
<li><a href="http://msdn.microsoft.com/library/windows/apps/ff476331">Compute Shader Overview</a>
