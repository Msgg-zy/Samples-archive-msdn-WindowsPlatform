...
bool CommModule::RegisterWithCCTHelper()
{
    ...
    {
        Diag::DebugPrint("Error while creating controlchanneltrigger" + e->Message + " Please add the app to the lockscreen.");
        return result;
    }
...
void CommModule::OnCanarySuccess(String^)
{
...
void CommModule::OnRequestSuccess(String^ response)
{
    IXMLHTTPRequest2* xhr = nullptr;
    ...
    try
    {
        if (this->channel_ != nullptr)
        {
            ...
            Diag::DebugPrint("Response: " + response);
        }
        else
        {
