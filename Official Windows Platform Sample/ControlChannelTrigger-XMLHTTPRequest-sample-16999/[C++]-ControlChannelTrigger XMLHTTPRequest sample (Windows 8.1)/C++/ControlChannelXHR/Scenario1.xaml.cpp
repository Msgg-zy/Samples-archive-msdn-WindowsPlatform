...
using namespace SDKSample::ControlChannelXHR;
...
String^ Scenario1::GetUrl()
{
    return Url->Text;
}

String^ Scenario1::GetPostData()
{
...
void Scenario1::CanaryButton_Click(Object^ sender, RoutedEventArgs^ e)
{
    String^ url = GetUrl();
