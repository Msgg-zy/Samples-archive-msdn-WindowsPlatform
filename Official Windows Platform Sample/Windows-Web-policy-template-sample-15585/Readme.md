...
Windows Web Services API</a> to manually create a policy description and use it to create the service proxy.
</p>
...
<dl><dt><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd401998"><b>WS_PROXY_PROPERTY</b></a>
</dt><dt><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd323432"><b>WS_SERVICE_PROXY</b></a>
</dt><dt><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430508"><b>WsCreateServiceProxyFromTemplate</b></a>
</dt></dl>
...
<ol>
<li>Open <b>Windows Explorer</b> and navigate to the directory. </li><li>Double-click the icon for the <b>PolicyTemplate.sln</b> (solution) file to open the file in Visual Studio.
...
<ol>
<li>Open the <b>Command Prompt</b> window and navigate to the directory. </li><li>Type <b>msbuild PolicyTemplate.sln</b> </li></ol>
