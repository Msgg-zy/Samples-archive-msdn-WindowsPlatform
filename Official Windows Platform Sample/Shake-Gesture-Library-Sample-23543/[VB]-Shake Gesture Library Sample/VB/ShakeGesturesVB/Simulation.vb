...
Namespace ShakeGestures
    Public Class Simulation
        Private Shared args As New AccelerometerHelperReadingEventArgs()

        Public Shared CallTo As EventHandler(Of AccelerometerHelperReadingEventArgs)

        Private Shared Sub ReportVector(ByVal x As Double, ByVal y As Double, ByVal z As Double)
            args.OptimalyFilteredAcceleration = New Simple3DVector(x, y, z)
            CallTo(Nothing, args)
        End Sub

        Public Shared Sub SimulateShakeX()
        ...
        Public Shared Sub SimulateShakeY()
        ...
        Public Shared Sub SimulateShakeZ()
