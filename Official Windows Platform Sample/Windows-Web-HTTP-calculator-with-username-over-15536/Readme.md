...
<h1><a id="gallery_samples.httpcalculatorwithusernameoversslservice_gallery"></a>Windows Web Services HTTP calculator with username over SSL service sample</h1>
</div>
<p>This sample demonstrates how the <a href="http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435">
Windows Web Services API</a> can use the service host for hosting a calculator service over HTTP, with username over SSL mixed-mode security. In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.
