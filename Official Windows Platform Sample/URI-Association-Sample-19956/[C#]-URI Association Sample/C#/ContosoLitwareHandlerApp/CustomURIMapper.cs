...
namespace ContosoLitwareHandlerApp
{
    class CustomUriMapper : UriMapperBase
    {
        ...
        public override Uri MapUri(Uri uri)
        {
            ...
            // URI association launch for litware handler page.
            if (tempUri.Contains("litware:ShowHandlerPage"))
            {
                ...
                // Construct new URI
                string NewURI = String.Format("/LitwareHandlerPage.xaml?OrigURI={0}", origUri);
