...
{
    public partial class Keyboard10 : PhoneApplicationPage
    {
        public Keyboard10()
        {
            InitializeComponent();
            ...
            name.NameValue = InputScopeNameValue.Formula;  //<--Here
            scope.Names.Add(name);

            txtK10.InputScope = scope;

            //To create keyboard 10, you can use any of the following Input Scopes.
            //--------------------------------------------------------------------
            // Formula
        }
