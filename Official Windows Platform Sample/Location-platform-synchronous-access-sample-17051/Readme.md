...
<div id="mainSection">
<p>This sample demonstrates how to access the Location platform in a synchronous manner.
</p>
...
<p>Go to the directory in which you unzipped the sample. Go to the directory named for the sample, and double-click the Microsoft Visual Studio Solution (.sln) file titled SimpleLocation.sln.</p>
</li><li>
