...
(function () {
    ...
    var inputManager = (function () {
        ...
        that.initialize = function () {
            ...
            svg.addEventListener('MSPointerDown', that.processDown, false);
            svg.addEventListener('MSPointerMove', that.processMove, false);
            svg.addEventListener('MSPointerUp', that.processUp, false);
            svg.addEventListener('MSPointerCancel', that.processUp, false);
