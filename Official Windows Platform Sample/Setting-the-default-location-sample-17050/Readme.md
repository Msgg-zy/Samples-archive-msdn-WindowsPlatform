...
<div id="mainSection">
<p>Demonstrates how to set the default location using the Location API. </p>
...
<p>Go to the directory in which you unzipped the sample. Go to the directory named for the sample, and double-click the Microsoft Visual Studio Solution (.sln) file titled SetLocation.sln.</p>
</li><li>
