# Windows Web Services HTTP calculator client sample
## Requires
* Visual Studio 2012
## License
* MS-LPL
...
Windows Web Services API</a> can use the service proxy to talk to an HTTP based calculator service.
</p>
...
</dt><dt><a href="http://go.microsoft.com/fwlink/p/?linkid=258655">Windows Web Services HTTP calculator service sample</a>
</dt></dl>
